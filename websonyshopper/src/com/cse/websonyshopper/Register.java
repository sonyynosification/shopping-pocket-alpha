...
public class Register {
	// HTTP Get Method
	@GET
	// Path http://localhost/<app-folder-name>/register/doregister
	@Path("doregister")
	// Produces JSON as response
	@Produces(MediaType.APPLICATION_JSON)
	// query parameters are parameters: http://localhost/<app-folder-name>/register/doregister?name=pqrs&username=abc&password=123
